    ...
    <aside :class="[
      ...
      <div class="flex items-center gap-3 px-4 py-5 border-b border-zinc-800 h-16 shrink-0">
        ...
        <button v-if="mobileOpen" @click="mobileOpen = false"
          class="ml-auto p-1 rounded-md text-zinc-400 hover:text-zinc-100 lg:hidden" aria-label="Close sidebar">
          <X class="w-4 h-4" />
        </button>
      </div>
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
      ...
      <header class="h-16 border-b border-zinc-800 bg-zinc-900 flex items-center gap-3 px-4 lg:px-6 shrink-0">
        <button @click="mobileOpen = !mobileOpen"
          class="p-2 rounded-lg text-zinc-400 hover:bg-zinc-800 hover:text-zinc-100 transition-colors lg:hidden" aria-label="Open menu">
          <Menu class="w-4 h-4" />
        </button>
