    ...
    <div class="card overflow-hidden">
      ...
      <template v-else>
            ...
            <tbody>
              ...
              >
                ...
                <td class="td">
                  ...
                  <p v-if="product.description" class="text-xs text-zinc-500 truncate max-w-xs">
                    {{ product.description }}
                  </p>
                </td>
                <td class="td">
                  <span class="badge-indigo">{{ product.category?.name }}</span>
                </td>
                ...
                <td class="td text-right">
                  <span class="text-xs font-medium text-emerald-400">+{{ product.profit_percentage }}%</span>
                </td>
                ...
                <td v-if="auth.canEdit || auth.canDelete" class="td text-center">
                  <div class="flex items-center justify-center gap-2">
                    <button
                      ...
                      class="btn-icon text-zinc-400 hover:text-indigo-400"
                      title="Edit"
                    >
                    ...
                    <button
                      ...
                      class="btn-icon text-zinc-400 hover:text-red-400"
                      title="Hapus"
                    >
        ...
        <div class="sm:hidden divide-y divide-zinc-800">
            ...
            <div class="flex items-start justify-between gap-3">
              <div class="min-w-0 flex-1">
                ...
                <div class="flex items-center gap-3 mt-2 flex-wrap">
                  ...
                  <span class="text-xs text-zinc-400">Jual: <strong class="text-zinc-200">Rp {{ formatPrice(product.list_price) }}</strong></span>
          ...
          <div v-if="products.length === 0" class="py-12 text-center text-zinc-500 text-sm">
        ...
        <div
          v-if="auth.isViewer"
          class="px-4 py-2.5 bg-zinc-800/30 border-t border-zinc-800 text-xs text-zinc-500"
        >
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div class="space-y-1.5">
                ...
                <input v-model="form.standard_cost" type="number" step="0.01" min="0" required class="input-field w-full" />
              </div>
              <div class="space-y-1.5">
                <label class="label">Harga Jual *</label>
                <input v-model="form.list_price" type="number" step="0.01" min="0" required class="input-field w-full" />
              </div>
            </div>
            <div class="space-y-1.5">
      ...
      <div v-if="showDeleteModal" class="modal-overlay" @click.self="showDeleteModal = false">
        <div class="modal-box sm:max-w-sm">
          ...
          <p class="text-sm text-zinc-400 mb-6">
            Produk <strong class="text-zinc-200">{{ deletingProduct?.name }}</strong> akan dihapus (soft delete).
          </p>
...
const defaultForm = () => ({
  name: '', sku: '', category_id: '' as number | '',
